...
""" usei o def para definir funções para facilitar o trabalho na hora de programar, não sei se podia usar pq não foi passado em sala de aula ainda, mas caso não pudesse enviarei tambem uma versão sem def, muito obrigado pela sua atenção"""
